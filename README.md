...
- Download the AppImage from from the latest [release](https://github.com/Dry-Leaf/kaimen/releases/tag/2.5)

### Windows

- Install [WinFSP](https://winfsp.dev/rel/)
- Restart your machine
- Download the latest [release](https://github.com/Dry-Leaf/kaimen/releases/tag/2.5)
